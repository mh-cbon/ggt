...
func (t *StringSlice) Transact(f func(*StringSlice)) {
	f(t)
}
...
// StringSliceContract are the requirements of StringSlice
type StringSliceContract interface {
	Push(x ...string) *StringSlice
	Unshift(x ...string) *StringSlice
	Pop() string
	Shift() string
	Index(s string) int
	...
	InsertAt(i int, s string) *StringSlice
	Splice(start int, length int, s ...string) []string
	Slice(start int, length int) []string
	Reverse() *StringSlice
	Set(x []string) *StringSlice
	Get() []string
	At(i int) string
	Filter(filters ...func(string) bool) *StringSlice
	Map(mappers ...func(string) string) *StringSlice
	First() string
	Last() string
	Transact(func(*StringSlice))
	Len() int
	Empty() bool
}
